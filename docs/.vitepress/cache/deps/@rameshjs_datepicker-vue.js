...
function mapToStyles(_ref2) {
  ...
  var _ref3 = roundOffsets === true ? roundOffsetsByDPR(offsets) : typeof roundOffsets === "function" ? roundOffsets(offsets) : offsets, _ref3$x = _ref3.x, x3 = _ref3$x === void 0 ? 0 : _ref3$x, _ref3$y = _ref3.y, y3 = _ref3$y === void 0 ? 0 : _ref3$y;
...
var ge = (e2, n) => {
  ...
  return Array.from({ length: o }, (s3, a3) => e2 + a3);
};
var U = 7;
var we = (e2, n) => {
  const t2 = new Date(n, e2, 1), o = t2.getDay(), s3 = [[]];
  let a3 = s3[0], r = t2;
  const u2 = [...Array(U).keys()];
  for (Array.from({ length: u2.indexOf(o) }, () => {
    a3.push(null);
  }); r.getMonth() === e2; )
    a3.length === U && (a3 = [], s3.push(a3)), a3.push(r), r = new Date(n, e2, r.getDate() + 1);
  for (; a3.length < U; )
    a3.push(null);
  return s3;
};
...
var x2 = (e2, n) => e2 > 10 ? { month: 0, year: n + 1 } : { month: e2 + 1, year: n };
var ae = (e2, n) => e2 < 1 ? { month: 11, year: n - 1 } : { month: e2 - 1, year: n };
var N = (e2, n) => e2 ? format(e2, n) : null;
var G2 = (e2, n) => {
...
var J = (e2, n) => e2 && n ? e2.getDate() === n.getDate() && e2.getMonth() === n.getMonth() && e2.getFullYear() === n.getFullYear() : false;
var M3 = {
  month: {
    type: Number,
...
var be = { class: "dp-nav-wrapper" };
var Ve = createBaseVNode("svg", {
...
var F = {
  ...
  setup(e2, { emit: n }) {
    const t2 = e2, o = () => {
      const { month: u2, year: p } = x2(t2.month, t2.year);
      n("update:month", u2), n("update:year", p), n("next-month");
    }, s3 = () => {
      const { month: u2, year: p } = ae(t2.month, t2.year);
    ...
    return (u2, p) => (openBlock(), createElementBlock("div", be, [
      ...
      createBaseVNode("div", Me, [
        createBaseVNode("button", {
          ...
          createTextVNode(toDisplayString(unref(le)[u2.month]) + " ", 1),
          Ce
        ]),
        createBaseVNode("button", {
...
var _e = { class: "dp-month-select-wrapper" };
var $e = ["onClick"];
var Re = {
  __name: "MonthPicker",
  props: {
  ...
  setup(e2, { emit: n }) {
    ...
    return (o, s3) => (openBlock(), createElementBlock("div", _e, [
      (openBlock(true), createElementBlock(Fragment, null, renderList(unref(le), (a3, r) => (openBlock(), createElementBlock("button", {
        key: r,
        ...
        onClick: (u2) => t2(r)
      }, toDisplayString(a3), 11, $e))), 128))
    ]));
  }
};
var Be = { class: "dp-year-select-wrapper" };
var Ee = ["onClick"];
var Ne = {
  __name: "YearPicker",
  props: {
  ...
  setup(e2, { emit: n }) {
    const t2 = e2, o = (a3) => {
      n("update:modelValue", a3);
    }, s3 = computed(() => ge(1972, t2.modelValue).reverse());
    return (a3, r) => (openBlock(), createElementBlock("div", Be, [
      (openBlock(true), createElementBlock(Fragment, null, renderList(unref(s3), (u2) => (openBlock(), createElementBlock("button", {
        ...
        class: normalizeClass({
          ...
          "dp-year-select-active-cell": u2 === a3.modelValue
        }),
        onClick: (p) => o(u2)
      }, toDisplayString(u2), 11, Ee))), 128))
    ]));
  }
};
var Te = {
...
var Ae = Object.assign(Te, {
  ...
  setup(e2, { emit: n }) {
    ...
    return (u2, p) => (openBlock(), createElementBlock("button", {
      class: normalizeClass([u2.allowRange ? unref(r) : unref(a3)]),
      onClick: s3
...
var xe = Object.assign(Ye, {
  ...
  setup(e2, { emit: n }) {
    const t2 = e2, o = (r) => {
      n("selectDate", r);
    }, s3 = computed(() => we(t2.month, t2.year)), a3 = computed(() => ke(t2.selectedDateRange));
    return (r, u2) => (openBlock(), createElementBlock("div", null, [
      createBaseVNode("div", Ue, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(ye), (p) => (openBlock(), createElementBlock("div", {
          key: p,
          class: "dp-weekday"
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList(unref(s3), (p) => (openBlock(), createElementBlock("div", {
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(p, (c2) => {
          ...
          return openBlock(), createElementBlock("div", {
            ...
            c2 ? (openBlock(), createBlock(Ae, {
              key: 0,
              day: c2,
              onSelectDate: o,
              "is-start": unref(J)((f = r.selectedDateRange) == null ? void 0 : f.start, c2),
              "is-end": unref(J)((h3 = r.selectedDateRange) == null ? void 0 : h3.end, c2),
              selected: unref(De)(unref(a3), c2),
...
var j = {
  ...
  setup(e2, { emit: n }) {
    ...
    return (r, u2) => (openBlock(), createElementBlock("div", Fe, [
      !e2.showMonthPicker && !e2.showYearPicker ? (openBlock(), createBlock(xe, {
        key: 0,
        month: unref(s3),
        year: unref(a3),
        onSelectDate: o,
      ...
      e2.showMonthPicker ? (openBlock(), createBlock(Re, {
        key: 1,
        modelValue: unref(s3),
        "onUpdate:modelValue": u2[0] || (u2[0] = (p) => isRef(s3) ? s3.value = p : null)
      }, null, 8, ["modelValue"])) : createCommentVNode("", true),
      e2.showYearPicker ? (openBlock(), createBlock(Ne, {
        key: 2,
        modelValue: unref(a3),
        "onUpdate:modelValue": u2[1] || (u2[1] = (p) => isRef(a3) ? a3.value = p : null)
      }, null, 8, ["modelValue"])) : createCommentVNode("", true)
    ]));
  }
};
...
var je = (e2) => typeof e2 == "string";
var ze = () => {
};
E2 && ((K2 = window == null ? void 0 : window.navigator) != null && K2.userAgent) && /iP(ad|hone|od)/.test(window.navigator.userAgent);
function Le(e2) {
...
var re = E2 ? window : void 0;
E2 && window.document;
E2 && window.navigator;
E2 && window.location;
function T2(...e2) {
  let n, t2, o, s3;
  if (je(e2[0]) || Array.isArray(e2[0]) ? ([t2, o, s3] = e2, n = re) : [n, t2, o, s3] = e2, !n)
    return ze;
  Array.isArray(t2) || (t2 = [t2]), Array.isArray(o) || (o = [o]);
  const a3 = [], r = () => {
    a3.forEach((f) => f()), a3.length = 0;
  }, u2 = (f, h3, k2) => (f.addEventListener(h3, k2, s3), () => f.removeEventListener(h3, k2, s3)), p = watch(() => $(n), (f) => {
    r(), f && a3.push(...t2.flatMap((h3) => o.map((k2) => u2(f, h3, k2))));
...
function H3(e2, n, t2 = {}) {
  const { window: o = re, ignore: s3 = [], capture: a3 = true, detectIframe: r = false } = t2;
  if (!o)
    return;
  let u2 = true, p;
  const c2 = (l) => s3.some((i2) => {
    if (typeof i2 == "string")
      return Array.from(o.document.querySelectorAll(i2)).some((d3) => d3 === l.target || l.composedPath().includes(d3));
    {
      const d3 = $(i2);
      return d3 && (l.target === d3 || l.composedPath().includes(d3));
    }
  }), f = (l) => {
    o.clearTimeout(p);
    const i2 = $(e2);
    if (!(!i2 || i2 === l.target || l.composedPath().includes(i2))) {
      if (l.detail === 0 && (u2 = !c2(l)), !u2) {
        u2 = true;
        return;
      }
      n(l);
    ...
    T2(o, "click", f, { passive: true, capture: a3 }),
    T2(o, "pointerdown", (l) => {
      const i2 = $(e2);
      i2 && (u2 = !l.composedPath().includes(i2) && !c2(l));
    }, { passive: true }),
    T2(o, "pointerup", (l) => {
      if (l.button === 0) {
        const i2 = l.composedPath();
        l.composedPath = () => i2, p = o.setTimeout(() => f(l), 50);
      }
    }, { passive: true }),
    r && T2(o, "blur", (l) => {
      var i2;
      const d3 = $(e2);
      ((i2 = o.document.activeElement) == null ? void 0 : i2.tagName) === "IFRAME" && !(d3 != null && d3.contains(o.document.activeElement)) && n(l);
    })
  ].filter(Boolean);
  return () => h3.forEach((l) => l());
}
var z2 = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {};
...
var X2 = Object.getOwnPropertySymbols;
var Ge = Object.prototype.hasOwnProperty;
var Je = Object.prototype.propertyIsEnumerable;
var Z = (e2, n, t2) => n in e2 ? Qe(e2, n, { enumerable: true, configurable: true, writable: true, value: t2 }) : e2[n] = t2;
var Ke = (e2, n) => {
  for (var t2 in n || (n = {}))
    Ge.call(n, t2) && Z(e2, t2, n[t2]);
  if (X2)
    for (var t2 of X2(n))
...
var ee = {
  ...
  emits: ["update:modelValue"],
  setup(e2, { emit: n }) {
    const t2 = e2, o = ref(false), s3 = ref(false), a3 = ref(t2.month), r = ref(t2.year), u2 = ref(null), p = (h3) => {
      t2.allowRange ? n("update:modelValue", oe(h3, t2.modelValue)) : n("update:modelValue", { start: h3, end: h3 });
    };
    watch(
      () => t2.modelValue,
      (h3) => {
        t2.modelValue.start && (a3.value = h3.start.getMonth(), r.value = h3.start.getFullYear());
      }
    );
    const c2 = (h3) => {
    ...
    return H3(u2, () => {
      ...
      createVNode(F, {
        month: a3.value,
        "onUpdate:month": k2[0] || (k2[0] = (l) => a3.value = l),
        year: r.value,
        "onUpdate:year": k2[1] || (k2[1] = (l) => r.value = l),
        onToggle: c2
      }, null, 8, ["month", "year"]),
      createVNode(j, {
        month: a3.value,
        "onUpdate:month": k2[2] || (k2[2] = (l) => a3.value = l),
        year: r.value,
        "onUpdate:year": k2[3] || (k2[3] = (l) => r.value = l),
...
var te = {
  ...
  emits: ["update:modelValue"],
  setup(e2, { emit: n }) {
    const t2 = e2, o = ref({ month: false, year: false }), s3 = ref({ month: false, year: false }), a3 = ref({ month: t2.month, year: t2.year }), r = ref(null), u2 = ref(x2(t2.month, t2.year)), p = (d3) => {
      n("update:modelValue", oe(d3, t2.modelValue));
    }, c2 = () => {
      const { month: d3, year: w2 } = a3.value;
      d3 >= u2.value.month && w2 >= u2.value.year && (u2.value = x2(
        a3.value.month,
        a3.value.year
      ));
    }, f = () => {
      const { month: d3, year: w2 } = u2.value;
      d3 <= a3.value.month && w2 <= a3.value.year && (a3.value = ae(
        u2.value.month,
        u2.value.year
      ));
    }, h3 = (d3) => {
    ...
    return watch(
      ...
      createBaseVNode("div", {
        ...
        createVNode(F, {
          month: a3.value.month,
          "onUpdate:month": w2[0] || (w2[0] = (D2) => a3.value.month = D2),
          year: a3.value.year,
          "onUpdate:year": w2[1] || (w2[1] = (D2) => a3.value.year = D2),
          onPrevMonth: c2,
          onNextMonth: c2,
          onToggle: h3
        }, null, 8, ["month", "year"]),
        createVNode(j, {
          month: a3.value.month,
          "onUpdate:month": w2[2] || (w2[2] = (D2) => a3.value.month = D2),
          year: a3.value.year,
          "onUpdate:year": w2[3] || (w2[3] = (D2) => a3.value.year = D2),
          "allow-range": "",
...
var et = { class: "absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none" };
var tt = createBaseVNode("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  fill: "none",
  viewBox: "0 0 24 24",
  "stroke-width": "1.5",
...
var nt = ["id", "placeholder"];
var lt = {
  name: "BaseInput"
};
var ne = Object.assign(lt, {
  props: {
    label: {
      type: String,
      default: ""
  ...
  setup(e2, { emit: n }) {
    ...
    return (r, u2) => (openBlock(), createElementBlock("div", null, [
      ...
      }, toDisplayString(e2.label), 9, Xe)) : createCommentVNode("", true),
...
var at = { key: 0 };
var ot = { class: "w-full flex flex-col lg:flex-row" };
var rt = {
  __name: "DatePicker",
  props: {
    ...M3,
  ...
  emits: ["update:modelValue"],
  setup(e2, { emit: n }) {
    const t2 = e2, o = ref(null), s3 = ref(false), a3 = ref(
      N(t2.modelValue.start, t2.formatDateInput)
    ), r = ref(
      N(t2.modelValue.end, t2.formatDateInput)
    );
    watch([a3, r], ([l, i2]) => {
      u2(
        G2(l, t2.formatDateInput),
        G2(i2, t2.formatDateInput)
      );
    });
    const u2 = (l, i2) => {
      ...
      a3.value = N(l, t2.formatDateInput), r.value = N(i2, t2.formatDateInput);
    }, c2 = computed({
      get() {
        return t2.modelValue;
      },
      set(l) {
        u2(l.start, l.end), p(l.start, l.end);
      }
    }), f = () => {
      s3.value = !s3.value;
    }, h3 = () => {
    ...
    return H3(o, () => {
      k2();
    }), (l, i2) => l.inline ? (openBlock(), createElementBlock("div", at, [
      l.multiMonth ? (openBlock(), createBlock(te, {
        key: 0,
        month: l.month,
        year: l.year,
        modelValue: unref(c2),
        "onUpdate:modelValue": i2[0] || (i2[0] = (d3) => isRef(c2) ? c2.value = d3 : null)
      }, null, 8, ["month", "year", "modelValue"])) : (openBlock(), createBlock(ee, {
        key: 1,
        month: l.month,
        year: l.year,
        modelValue: unref(c2),
        "onUpdate:modelValue": i2[1] || (i2[1] = (d3) => isRef(c2) ? c2.value = d3 : null),
        allowRange: l.allowRange
      ...
      default: withCtx(() => [
        renderSlot(l.$slots, "trigger-datepicker", { toggle: f }, () => [
          renderSlot(l.$slots, "datepicker-input", {
            startDate: a3.value,
            endDate: r.value,
            toggle: f,
            showPopover: h3,
            ...
            createBaseVNode("div", ot, [
              createVNode(ne, {
                ...
                modelValue: a3.value,
                "onUpdate:modelValue": i2[2] || (i2[2] = (d3) => a3.value = d3),
                onFocus: h3
              }, null, 8, ["label", "placeholder", "modelValue"]),
              l.allowRange || l.multiMonth ? (openBlock(), createBlock(ne, {
                key: 0,
